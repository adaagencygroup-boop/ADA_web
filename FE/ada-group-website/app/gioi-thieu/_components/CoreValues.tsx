          ...
          {VALUES.map((value) => (
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-lg font-semibold leading-[23px] text-slate-900 lg:text-xl lg:leading-7">
                  {value.title}
                </h3>
              </div>
              <p className="text-base text-justify leading-4.5 text-zinc-500 lg:leading-[23px] lg:text-gray-600">
                {value.description}
              </p>
            </div>
          ))}
