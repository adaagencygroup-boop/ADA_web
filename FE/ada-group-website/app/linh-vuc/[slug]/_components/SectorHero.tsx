    ...
    <GsapHeroReveal>
      <section className="section-y">
        <div className="mx-auto max-w-360 px-4 sm:px-6 lg:flex lg:items-center lg:gap-(--inner-space) lg:px-8">
          <div className="hero-text-left flex flex-col items-start gap-3 lg:max-w-139 lg:shrink-0 lg:gap-(--heading-space)">
          ...
          <div className="hero-image-right relative mt-(--inner-space) aspect-358/200 w-full overflow-hidden rounded-2xl lg:mt-0 lg:aspect-681/430 lg:flex-1">
            <Image
              src={sector.imageUrl}
              alt={sector.title}
              fill
