    ...
    <section className="bg-[#002A64] section-y max-md:py-5!">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-center flex flex-col items-center">
          <h2 className="text-[1.75rem] font-semibold leading-snug tracking-tight text-white sm:text-3xl lg:text-[2.5rem] mb-6 max-w-4xl">
            Bạn đang có một ý tưởng cho ứng dụng Mobile?
          </h2>
          
          <p className="text-base lg:text-[17px] font-medium text-white mb-4">
            Biến ý tưởng thành sản phẩm số hoàn chỉnh
          </p>
          
          <p className="text-[14px] lg:text-[15px] leading-relaxed text-blue-100 max-w-2xl mb-10 px-4 md:px-0 whitespace-pre-line">
            Từ một ý tưởng ban đầu đến một hệ thống Mobile hoàn chỉnh, ADA Group sẵn sàng cùng bạn{"\n"}xác định nhu cầu và lựa chọn hướng triển khai phù hợp.
          </p>
