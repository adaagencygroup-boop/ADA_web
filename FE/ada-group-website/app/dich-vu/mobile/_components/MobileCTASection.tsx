    ...
    <section className="bg-[#002A64] section-y">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-base lg:text-[17px] font-medium text-white mb-(--inner-space)">
            Biến ý tưởng thành sản phẩm số hoàn chỉnh
          </p>
          
          <p className="text-[14px] lg:text-[15px] leading-relaxed text-blue-100 max-w-2xl mb-(--section-padding) px-4 md:px-0 whitespace-pre-line">
