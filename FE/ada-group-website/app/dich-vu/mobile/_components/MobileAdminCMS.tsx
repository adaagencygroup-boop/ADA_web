  ...
  return (
    <section className="bg-white section-y max-md:py-5! md:pt-0!">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-0 lg:gap-16 items-center lg:mb-16 bg-white lg:bg-transparent rounded-4xl lg:rounded-none border border-slate-100 lg:border-none shadow-sm lg:shadow-none overflow-hidden lg:overflow-visible">
          {/* Left Column: Image (Top on Mobile) */}
          <div className="relative w-full aspect-4/3 sm:aspect-video lg:aspect-16/10 bg-slate-100 lg:rounded-3xl overflow-hidden shadow-none lg:shadow-sm border-b lg:border border-slate-100 order-1">
          ...
          {headerContent.map((item, index) => (
            <div key={index} className="flex flex-col p-6 sm:p-8 lg:p-0 order-2">
              ...
              <Link href="/lien-he" className="lg:hidden mt-2 inline-flex items-center gap-2 text-blue-600 font-semibold text-[14px] hover:text-blue-800 transition-colors w-fit">
                Xem chi tiết &rarr;
              </Link>
            </div>
          ))}
        ...
        <div className="hidden lg:grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-[#f8fafc] rounded-3xl p-6 lg:p-8 border border-slate-100 flex flex-col items-center text-center">
            ...
            <p className="text-[13px] text-zinc-500 leading-relaxed mb-8 max-w-62.5">
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.05)] w-full max-w-[320px] p-5 text-left border border-slate-100/50 mt-auto">
              ...
              <div className="grid grid-cols-3 gap-2 pb-2 border-b border-slate-100 mb-3">
          ...
          <div className="bg-[#f8fafc] rounded-3xl p-6 lg:p-8 border border-slate-100 flex flex-col items-center text-center">
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.05)] w-full max-w-[320px] p-5 text-left border border-slate-100/50 mt-auto">
              ...
              <span className="text-[9px] font-semibold text-slate-800 block mb-2">Biểu đồ hoạt động</span>
        ...
        <div className="hidden lg:flex bg-[#eef4ff] rounded-2xl p-4 lg:p-6 items-center justify-between border border-[#d6e5ff]">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-[14px] font-semibold text-slate-900 mb-0.5">Bảo mật & phân quyền</span>
