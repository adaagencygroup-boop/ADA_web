              ...
              return (
                <div key={item.id} className="lg:col-span-2 bg-white lg:bg-blue-50 rounded-3xl lg:rounded-4xl flex flex-col-reverse lg:flex-row overflow-hidden text-zinc-900 lg:text-white shadow-[0_2px_20px_rgb(0,0,0,0.04)] lg:shadow-xl border border-slate-100 lg:border-none">
                  <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center lg:max-w-[50%]">
                    ...
                    <div className="hidden lg:block text-[14px] text-zinc-500 mb-(--section-padding) leading-relaxed whitespace-pre-line text-justify">
                      {item.description}
                    </div>
                    <Link href="/lien-he" className="text-[14px] text-blue-600 lg:text-blue-600 font-medium hover:text-blue-700 lg:hover:text-blue-300 inline-flex items-center gap-(--inner-space).5 w-fit transition-colors">
