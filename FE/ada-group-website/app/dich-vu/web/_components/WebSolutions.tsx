    ...
    <section className="bg-white section-y">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-(--section-padding) md:mb-(--section-padding)">
          <div className="flex items-center justify-center gap-(--inner-space).5 mb-(--inner-space) text-blue-600">
              ...
              return (
                <div key={item.id} className="lg:col-span-2 bg-white lg:bg-[#0b1120] rounded-3xl lg:rounded-4xl flex flex-col-reverse lg:flex-row overflow-hidden text-zinc-900 lg:text-white shadow-[0_2px_20px_rgb(0,0,0,0.04)] lg:shadow-xl border border-slate-100 lg:border-none">
                  <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center lg:max-w-[50%]">
                    <div className="block lg:hidden mb-(--inner-space)">
                      <p className="text-[13px] font-semibold text-slate-500 uppercase tracking-wide mb-(--heading-space) text-justify">
                    ...
                    <div className="hidden lg:block">
                      ...
                      <h3 className="text-2xl font-semibold uppercase mb-(--heading-space) text-white text-justify">{item.title}</h3>
                      <p className="text-[15px] font-semibold text-blue-400 mb-(--inner-space) text-justify">{item.subtitle}</p>
                    </div>

                    <div className="hidden lg:block text-[14px] text-slate-300 mb-(--section-padding) leading-relaxed whitespace-pre-line text-justify">
                      {item.description}
                    </div>
                ...
                <div key={item.id} className="lg:col-span-2 bg-[#f4f6f9] rounded-3xl lg:rounded-4xl flex flex-col-reverse lg:flex-row overflow-hidden shadow-sm border border-slate-100">
                  <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center lg:max-w-[50%]">
                    ...
                    <div className="hidden lg:block">
                      ...
                      <h3 className="text-2xl font-semibold uppercase mb-(--heading-space) text-zinc-900 text-justify">{item.title}</h3>
                      <p className="text-[15px] font-semibold text-blue-600 mb-(--inner-space) text-justify">{item.subtitle}</p>
                    </div>

                    <div className="hidden lg:block text-[14px] text-zinc-600 mb-(--section-padding) leading-relaxed whitespace-pre-line text-justify">
                      {item.description}
                    </div>
              ...
              <div key={item.id} className="bg-white rounded-3xl lg:rounded-4xl border border-slate-100 shadow-[0_2px_20px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col-reverse xl:flex-row h-full">
                <div className="p-6 lg:p-8 flex-1 flex flex-col">
                  ...
                  <div className="hidden lg:block">
                    ...
                    <h3 className="text-lg lg:text-xl font-semibold uppercase mb-(--heading-space) text-zinc-900 leading-snug text-justify">{item.title}</h3>
                    <p className="text-[14px] font-semibold text-blue-600 mb-(--inner-space) text-justify">{item.subtitle}</p>
                  </div>

                  <div className="hidden lg:block text-[14px] text-zinc-500 mb-(--inner-space) leading-[1.6] whitespace-pre-line flex-1 text-justify">
                    {item.description}
                  </div>
