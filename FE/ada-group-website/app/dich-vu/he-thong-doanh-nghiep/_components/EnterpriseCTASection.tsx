    ...
    <section className="bg-[#002A64] section-y max-md:py-5!">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-[15px] sm:text-base leading-relaxed text-blue-100 max-w-2xl mb-3">
          ...
          <p className="text-sm leading-relaxed text-blue-200/80 max-w-2xl mb-8">
          ...
          <div className="flex flex-col w-full px-4 sm:px-0 sm:w-auto sm:flex-row items-center justify-center gap-4 pt-2">
            <Link
              href="/lien-he"
