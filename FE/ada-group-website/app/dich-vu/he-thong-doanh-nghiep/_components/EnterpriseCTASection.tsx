    ...
    <section className="bg-[#002A64] section-y">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-[14px] lg:text-[16px] leading-relaxed text-blue-100 max-w-2xl mb-(--heading-space) px-4 md:px-0">
          ...
          <p className="text-[14px] lg:text-[16px] leading-relaxed text-blue-200/80 max-w-2xl mb-(--inner-space) px-4 md:px-0">
