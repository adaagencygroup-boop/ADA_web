  ...
  return (
    <section className="bg-white section-y max-md:py-5! border-t border-slate-100">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_480px] gap-(--section-padding) items-center">
          ...
          <div className="w-full bg-[#f8fafc] rounded-3xl lg:rounded-4xl border border-slate-100 shadow-[inset_0_0_40px_rgb(0,0,0,0.02)] hidden lg:flex flex-col items-center justify-center py-10 px-8">
            ...
            <div className="flex flex-col items-center">
              <span className="text-[11px] font-semibold uppercase tracking-wider text-blue-900 mb-(--heading-space)">BÀI TOÁN</span>
            ...
            <div className="relative w-full max-w-xs">
              ...
              {/* 3 Options */}
              <div className="grid grid-cols-3 gap-(--inner-space) relative z-10">
                {/* Software */}
                <div className="bg-white rounded-2xl p-4 flex flex-col items-center justify-center gap-(--inner-space) shadow-[0_2px_12px_rgb(0,0,0,0.05)] border border-slate-100 hover:-translate-y-1 transition-transform cursor-default">
                ...
                <div className="bg-white rounded-2xl p-4 flex flex-col items-center justify-center gap-(--inner-space) shadow-[0_2px_12px_rgb(0,0,0,0.05)] border border-slate-100 hover:-translate-y-1 transition-transform cursor-default">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_520_3889)">
                    <path d="M9 12C9 13.6557 10.3443 15 12 15C13.6557 15 15 13.6557 15 12C15 10.3443 13.6557 9 12 9C10.3443 9 9 10.3443 9 12V12" stroke="#3B82F6" strokeWidth="2"/>
