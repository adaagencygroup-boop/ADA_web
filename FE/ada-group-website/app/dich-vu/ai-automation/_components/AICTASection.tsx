  ...
  return (
    <section className="bg-white section-y max-md:py-5!">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center gap-5 lg:gap-6">
          ...
          <p className="text-[14px] lg:text-[15px] leading-relaxed text-zinc-500 max-w-4xl mb-2 lg:mb-4 px-2 md:px-0">
          ...
          <div className="pt-2 w-full px-4 sm:px-0 flex justify-center">
            <Link
              href="/lien-he"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 font-medium text-white transition-all 
              rounded-full bg-[#0a2347] px-8 py-3 text-[14px] hover:bg-[#163a73] shadow-md hover:shadow-lg"
            >
