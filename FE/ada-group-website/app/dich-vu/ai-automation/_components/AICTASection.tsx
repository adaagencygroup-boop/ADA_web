    ...
    <section className="bg-white section-y pt-0!">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center gap-(--inner-space)">
          ...
          <p className="text-[14px] lg:text-[15px] leading-relaxed text-zinc-500 max-w-4xl mb-(--inner-space) px-2 md:px-0">
          ...
          <div className="pt-(--heading-space) w-full px-4 sm:px-0 flex justify-center">
            <Link
              href="/lien-he"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-(--inner-space) font-medium text-white transition-all 
