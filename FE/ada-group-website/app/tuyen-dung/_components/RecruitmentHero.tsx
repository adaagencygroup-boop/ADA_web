      ...
      <div className="relative z-10 mx-auto w-full max-w-360 grid grid-cols-1 lg:grid-cols-2 grow">
        ...
        <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-10 lg:py-16 xl:py-24 text-white">
          <div className="max-w-xl mx-auto lg:mx-0 w-full">
            <div className="inline-block bg-[#1a56db] border border-blue-400/30 text-white px-3 py-1.5 rounded-full font-bold tracking-widest uppercase mb-4 text-[10px] lg:text-[12px] w-fit">
              CƠ HỘI NGHỀ NGHIỆP TẠI
            </div>
            <h1 className="text-[1.8rem] sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 lg:mb-6 tracking-tight uppercase leading-tight lg:leading-none">
              ADA GROUP
            </h1>
